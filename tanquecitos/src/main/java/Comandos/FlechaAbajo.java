 ...
 * @author wisfer
 */
public class FlechaAbajo extends Comando{

    Tanque jugador;

    public FlechaAbajo(Tanque jugador) {
    ...
    public void execute(VentanaJuego ventana) {
        ...
        jugador.direccion = Tanque.ABAJO;
        ...
        jugador.setIcon(jugador.getTexturaPrincipalAbajo1());        
        try{
